...
- Deadlocks reduced from routinely hundreds per day (with peaks exceeding 3,400/day) to a sustained operational baseline typically between 0-5/day.
...
#### Figure 1 – Deadlock Reduction Over Time
